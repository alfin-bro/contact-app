        ...
        <div className="container py-5">
            ...
            <div className={modalWrapper}>
                ...
                <div className="content text-center py-2">
                    ...
                    <p className="text-muted text-secondary">You can add contact more in page add contact</p>
                </div>
                <div className="modal-trigger">
                    <Link to="/" className="btn btn-primary px-5 py-3 shadow-lg">Go home</Link>
                </div>
            </div>
        </div>
    )
